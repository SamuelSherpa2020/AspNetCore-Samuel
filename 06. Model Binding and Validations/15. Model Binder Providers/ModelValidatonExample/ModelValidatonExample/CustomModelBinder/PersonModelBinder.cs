...
namespace ModelValidatonExample.CustomModelBinder
{
    public class PersonModelBinder : IModelBinder
    {
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            //ConfirmPassword
            if (bindingContext.ValueProvider.GetValue("ConfirmedPassword").Length > 0)
                person.ConfirmedPassword = bindingContext.ValueProvider.GetValue("ConfirmedPassword").FirstValue;
